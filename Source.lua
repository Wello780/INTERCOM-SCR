...
github shezan78		discord shezan#8827
...
function Library:create(options)
	...
	options = self:set_defaults({
		...
		Link = "https://github.com/AvalonMods/Avalon-UI-Lib"
	}, options)
	...
	creditsTab:credit{Name = "Jaysmash_", Description = "Co-Founder", Discord = "jaysmash_", V3rmillion = "We dont have one :("}
	creditsTab:credit{Name = "Deity", Description = "UI Library Developer", Discord = "Deity#0228", V3rmillion = "0xDEITY"}
    creditsTab:credit{Name = "Wello890", Description = "Founder", Discord = "wello890", V3rmillion = "We dont have one :("}
	return mt
end
